        ...
        else if(Count_Child(ast) == 3)
        {
                if((!(strcmp(Get_Child(ast,0)->nodename,"LP") == 0 &&\
                        ...
                        */
                                ...
                                strcmp(Get_Child(ast,1)->nodename,"ASSIGNOP")== 0)
                        {
                                ...
                                if(Count_Child(ast->cld) == 1 &&\
                                        ...
                                        {
                                                printf("num: %d cld1:%s\n",Count_Child(ast->cld),ast->cld->cld->nodename);
                        ...
                        */
                        ...
                        {
                                assert(t1 != NULL);
                                printf("Enter Handle_Exp exp and exp %d \n",t1->kind);
                ...
                {
                        printf("Enter Handle_Exp LP EXP RP\n");
                        return tmid;
                }
                }
                /*TODO:Exp:|ID LP RP
...
void Handle_Stmt(struct node *stmt, Type t)
{
	...
	{
        printf("Enter IF LP EXP RP ELSE STMT\n");
         //        printf("700000\n");
