...
ExtDefList : {$$=nodecreate("ExtDefList",0);}
   ...
   ;
ExtDef : Specifier ExtDecList SEMI {nodelist[0]=$1;nodelist[1]=$2;nodelist[2]=$3;$$=nodecreate("ExtDef",3);}
...
Exp : Exp ASSIGNOP Exp {nodelist[0]=$1;nodelist[1]=$2;nodelist[2]=$3;$$=nodecreate("Exp",3);}
